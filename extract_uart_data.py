...
filename = "results_uart.txt"
real_class = "fire" # Change this to the real class you want to analyze
fontsize = 12
...
plt.tight_layout()
plt.savefig("predictions_analysis.pdf")

# Open the PDF file using the default PDF viewer
subprocess.Popen("predictions_analysis.pdf", shell=True)