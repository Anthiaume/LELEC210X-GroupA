...
# print("MAC")
# # Charger le fichier CSV
# df = pd.read_csv("C:\\Users\\ismae\\Desktop\\UCLouvain\\Master\\Codes Pythons\\Jonathan.csv", comment=';', sep=',')

# df_tronc = df[(df["Time(S)"] >= -1.13) & (df["Time(S)"] <= 0.579)]
# t0 = df_tronc["Time(S)"].iloc[0]
# df_tronc["Time_shifted"] = df_tronc["Time(S)"] - t0
# # df_tronc["CH1(V)"] = df_tronc["CH1(V)"] - df_tronc["CH1(V)"].iloc[0]
# # df_tronc["CH2(V)"] = df_tronc["CH2(V)"] - df_tronc["CH2(V)"].iloc[0]
...
# plt.figure(figsize=(12, 6))
# plt.plot(df_tronc["Time_shifted"], df_tronc["CH1(V)"], label="Jonathan")
# plt.title("Voltage CH1 with Jonathan")
# plt.grid(True)
# plt.legend()
# plt.show()
...
# df_power_mcu["Power_MCU(mW)"] = df_votage_mcu["Voltage_MCU(V)"] * df_current["Current(A)"] * 1000
# plt.figure(figsize=(12, 6))
# plt.plot(df_power_mcu["Time_shifted"], df_power_mcu["Power_MCU(mW)"], label="Power Jonathan")
# plt.title("Power MCU with Jonathan")
# plt.ylabel("Power MCU (mW)")
# plt.grid(True)
# plt.legend()
# plt.show()
...
# df_power_mcu_Jonathan = df_power_mcu.copy()


# ############################ UART DISABLED ##################################
# print("MAC")
# # Charger le fichier CSV
# df = pd.read_csv("C:\\Users\\ismae\\Desktop\\UCLouvain\\Master\\Codes Pythons\\Jonhy.csv", comment=';', sep=',')

# df_tronc = df[(df["Time(S)"] >= -1.056) & (df["Time(S)"] <= 0.643)]
# t0 = df_tronc["Time(S)"].iloc[0]
# df_tronc["Time_shifted"] = df_tronc["Time(S)"] - t0
# # df_tronc["CH1(V)"] = df_tronc["CH1(V)"] - df_tronc["CH1(V)"].iloc[0]
# # df_tronc["CH2(V)"] = df_tronc["CH2(V)"] - df_tronc["CH2(V)"].iloc[0]
...
# plt.figure(figsize=(12, 6))
# plt.plot(df_tronc["Time_shifted"], df_tronc["CH1(V)"], label="Jonhy")
# plt.title("Voltage CH1 with Jonhy")
# plt.grid(True)
# plt.legend()
# plt.show()
...
# df_power_mcu["Power_MCU(mW)"] = df_votage_mcu["Voltage_MCU(V)"] * df_current["Current(A)"] * 1000
# plt.figure(figsize=(12, 6))
# plt.plot(df_power_mcu["Time_shifted"], df_power_mcu["Power_MCU(mW)"], label="Power Jonhy")
# plt.title("Power MCU with Jonhy")
# plt.ylabel("Power MCU (mW)")
# plt.grid(True)
# plt.legend()
# plt.show()
...
# df_power_mcu_Jonhy = df_power_mcu.copy()


############################ UART DISABLED ##################################
print("MAC")
# Charger le fichier CSV
df = pd.read_csv("C:\\Users\\ismae\\Desktop\\UCLouvain\\Master\\Codes Pythons\\Power_MCU_FFT1.csv", comment=';', sep=',')

df_tronc = df[(df["Time(S)"] >= -0.452) & (df["Time(S)"] <= 1.247)]
t0 = df_tronc["Time(S)"].iloc[0]
df_tronc["Time_shifted"] = df_tronc["Time(S)"] - t0
# df_tronc["CH1(V)"] = df_tronc["CH1(V)"] - df_tronc["CH1(V)"].iloc[0]
# df_tronc["CH2(V)"] = df_tronc["CH2(V)"] - df_tronc["CH2(V)"].iloc[0]
...
plt.figure(figsize=(12, 6))
plt.plot(df_tronc["Time_shifted"], df_tronc["CH1(V)"], label="Power_MCU_FFT1")
plt.title("Voltage CH1 with Power_MCU_FFT1")
plt.grid(True)
plt.legend()
plt.show()
...
df_power_mcu["Power_MCU(mW)"] = df_votage_mcu["Voltage_MCU(V)"] * df_current["Current(A)"] * 1000
plt.figure(figsize=(12, 6))
plt.plot(df_power_mcu["Time_shifted"], df_power_mcu["Power_MCU(mW)"], label="Power Power_MCU_FFT1")
plt.title("Power MCU with Power_MCU_FFT1")
plt.ylabel("Power MCU (mW)")
plt.grid(True)
plt.legend()
plt.show()
...
df_power_mcu_Power_MCU_FFT1 = df_power_mcu.copy()


# plt.figure(figsize=(12, 6))
# plt.plot(df_power_mcu_Jonathan["Time_shifted"], df_power_mcu_Jonathan["Power_MCU(mW)"], label="Power Jonathan")
# plt.plot(df_power_mcu_Jonhy["Time_shifted"], df_power_mcu_Jonhy["Power_MCU(mW)"], label="Power Jonhy")
# plt.title("Power MCU with high and low clock")
# plt.ylabel("Power MCU (mW)")
# plt.grid(True)
# plt.legend()
