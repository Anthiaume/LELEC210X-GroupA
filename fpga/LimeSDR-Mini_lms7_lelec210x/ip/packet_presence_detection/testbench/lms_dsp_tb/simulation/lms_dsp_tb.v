...
module lms_dsp_tb (
	...
	wire   [0:0] lms_dsp_inst_ppd_bfm_conduit_cfg_enable_fir;      // lms_dsp_inst_ppd_bfm:sig_cfg_enable_fir -> lms_dsp_inst:ppd_cfg_enable_fir
	wire   [0:0] lms_dsp_inst_ppd_bfm_conduit_cfg_red_sum_signal;  // lms_dsp_inst_ppd_bfm:sig_cfg_red_sum_signal -> lms_dsp_inst:ppd_cfg_red_sum_signal
	wire  [31:0] lms_dsp_inst_ppd_debug_count;                     // lms_dsp_inst:ppd_debug_count -> lms_dsp_inst_ppd_bfm:sig_debug_count
	wire   [0:0] lms_dsp_inst_ppd_bfm_conduit_cfg_pass_sum_signal; // lms_dsp_inst_ppd_bfm:sig_cfg_pass_sum_signal -> lms_dsp_inst:ppd_cfg_pass_sum_signal
	...
	wire   [0:0] lms_dsp_inst_ppd_bfm_conduit_cfg_enable_ppd;      // lms_dsp_inst_ppd_bfm:sig_cfg_enable_ppd -> lms_dsp_inst:ppd_cfg_enable_ppd
	...
	lms_dsp lms_dsp_inst (
		...
		.ppd_cfg_enable_fir      (lms_dsp_inst_ppd_bfm_conduit_cfg_enable_fir),      //         .cfg_enable_fir
		.ppd_cfg_enable_ppd      (lms_dsp_inst_ppd_bfm_conduit_cfg_enable_ppd),      //         .cfg_enable_ppd
		.ppd_cfg_pass_sum_signal (lms_dsp_inst_ppd_bfm_conduit_cfg_pass_sum_signal), //         .cfg_pass_sum_signal
		.ppd_cfg_red_sum_signal  (lms_dsp_inst_ppd_bfm_conduit_cfg_red_sum_signal),  //         .cfg_red_sum_signal
	...
	altera_conduit_bfm_0003 lms_dsp_inst_ppd_bfm (
		...
		.sig_cfg_enable_fir      (lms_dsp_inst_ppd_bfm_conduit_cfg_enable_fir),      //        .cfg_enable_fir
		.sig_cfg_enable_ppd      (lms_dsp_inst_ppd_bfm_conduit_cfg_enable_ppd),      //        .cfg_enable_ppd
		.sig_cfg_pass_sum_signal (lms_dsp_inst_ppd_bfm_conduit_cfg_pass_sum_signal), //        .cfg_pass_sum_signal
		.sig_cfg_passthrough_len (lms_dsp_inst_ppd_bfm_conduit_cfg_passthrough_len), //        .cfg_passthrough_len
		.sig_cfg_red_sum_signal  (lms_dsp_inst_ppd_bfm_conduit_cfg_red_sum_signal),  //        .cfg_red_sum_signal
